...
public class AboutActivity extends Activity implements OnClickListener {
	...
	private void setSelet(int i) {
		...
		case 1:
			...
			button1.setImageResource(R.drawable.play_press);
		...
		case 2:
			...
			button2.setImageResource(R.drawable.develop_press);
		...
		case 3:
			...
			button3.setImageResource(R.drawable.module_press);
		...
		case 4:
			...
			button4.setImageResource(R.drawable.else_press);
	...
	private void resetIcon() {
		// TODO Auto-generated method stub
		button1.setImageResource(R.drawable.play_normal);
		text1.setTextColor(Color.GRAY);
		button2.setImageResource(R.drawable.develop_normal);
		text2.setTextColor(Color.GRAY);
		button3.setImageResource(R.drawable.module_normal);
		text3.setTextColor(Color.GRAY);
		button4.setImageResource(R.drawable.else_normal);
