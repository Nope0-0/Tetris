...
public class MainActivity extends Activity implements ComeBackAdapter,OnTouchListener {
	...
	Handler handler= new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case  1:
				...
				case 50:
					backPlay.playEight();Score = ground.getScore();break;
				case 100:
					backPlay.playNine();Score = ground.getScore();break;
				case 200:
					backPlay.playTen();Score = ground.getScore();break;
				case 400:
					backPlay.playEleven();Score = ground.getScore();break;
				default: break;
				}
				break;
			case  2:
	...
	class TimeThread implements Runnable{
		...
		public void run() {
			// TODO Auto-generated method stub
			while(true){
				Time t=new Time(); // or Time t=new Time("GMT+8"); 设置时区
				t.setToNow();
				gaT.hour = t.hour; 
				gaT.minute = t.minute;      
				gaT.sec = t.second; 
