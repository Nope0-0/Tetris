...
public class SettingPage extends Activity implements OnClickListener,OnSeekBarChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Transverse = (EditText) findViewById(R.id.Transverse);
		Longitudinal = (EditText) findViewById(R.id.Longitudinal);
		touchLength = (EditText) findViewById(R.id.touchLength);
